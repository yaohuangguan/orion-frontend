...
import { PirateLordsGame } from '../../components/private/leisure/PirateLordsGame';
...
export const LeisureSpace: React.FC<LeisureSpaceProps> = ({ user }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 h-full overflow-y-auto custom-scrollbar xl:pl-2 pb-20 order-3 flex-1 min-w-0">
