...
export const NewYearTheme: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-gradient-to-b from-[#450a0a] via-[#7f1d1d] to-[#9a3412]">
      ...
      <div
        className="absolute top-0 left-[25%] text-4xl md:text-6xl select-none filter drop-shadow-xl origin-top opacity-90 animate-[swing_7s_ease-in-out_infinite]"
        style={{ animationDelay: '1s' }}
      >
        🏮
      </div>
      <div
        className="absolute top-0 right-[10%] text-6xl md:text-8xl select-none filter drop-shadow-2xl origin-top animate-[swing_6s_ease-in-out_infinite]"
        style={{ animationDelay: '2s' }}
      >
        🏮
      </div>
      <div
        className="absolute top-0 right-[25%] text-4xl md:text-6xl select-none filter drop-shadow-xl origin-top opacity-90 animate-[swing_7s_ease-in-out_infinite]"
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-12 opacity-80">
        ...
        <span className="text-6xl animate-bounce" style={{ animationDuration: '4s' }}>
          💰
        </span>
        <span className="text-6xl animate-bounce" style={{ animationDuration: '3.5s' }}>
          🧧
        </span>
      </div>
    </div>
