export const zh = {
  ...
  hero: {
    ...
    introPrefix: '我是 ',
    introName: 'Sam',
    introSuffix: '。欢迎来到我的数字空间，这里记录着我的个人感悟、简历历程与开发项目。作为一名全栈工程师，构建这个网站纯粹出于我的兴趣与热爱，我乐在其中，也真诚地希望你能在这里收获一份快乐。',
    ctaPrimary: '查阅日志',
  ...
  resume: {
      ...
      sections: {
        public: {
          ...
          features: [
            ...
            '双模式档案室：简历文档模式 / 项目卡片模式，中英双语一键切换。',
            '个人电子简历管理：支持创建多份针对不同岗位的简历，自由配置内容，支持一键导出 ATS 兼容的可选文本 PDF。',
            '简历排版自定义：可随意更改简历内容的字体、大小、颜色、行高、页面边距与版面排版，支持长图/分页双打印模式。',
    ...
    aboutTitle: '关于 Sam',
    aboutP1: '我选择软件工程，是因为我热切期盼着亲眼见证自己编写的代码切实地改善人们的生活，优化其日常工作流程。在腾讯云，我负责升级了 CI/CD 平台，每当看到开发团队构建和部署代码的速度显著提升，我都感到无比自豪。后来在货拉拉，看到自己研发的司机端功能能让货车司机们的日常物流工作更加便捷省力，这对我而言具有非凡的意义。在这份职业中，我最享受的过程便是征服复杂的技术瓶颈，并将其沉淀为稳健、好用、能为用户创造即时价值的优秀工具。',
    aboutP2: '目前，我正在奥克兰大学攻读信息技术硕士学位，这进一步深化了我对前沿计算机科学概念的认知，并融入了当地的技术实践。在工程实践上，我积极专注于构建现代化全栈 Web 应用，精进 React、TypeScript、Node.js 与云端基础设施的开发技能。在此期间，我修读并掌握了 COMPSCI 734（网络、移动端与企业级计算）、COMPSCI 742（高级互联网：全球数据通信）、INFOSYS 735（云计算架构）以及 DIGIHLTH 706（健康数据分析）等核心领域。同时，我还很荣幸能担任 COMPSCI 734 的学生代表，这使我能够进一步锻炼跨文化团队间的清晰沟通与反馈整理，搭建起学生群体与教学团队之间顺畅沟通的桥梁。',
    aboutP3: '我的独特之处，在于拥有融合了深圳、香港与美国的跨地域全栈开发视野，以及运营个人投资创业项目的实战商业经验。这一复合背景培养了我兼顾“商业价值”与“技术实现”的宏观视角，拥有强烈的 Owner 意识，并深谙如何在实际高压环境下稳定交付高水准成果。凭借出色的跨职能协作力，我能够迅速融入复杂代码库、无缝沟通并推进复杂任务的百分百落地。回望工程旅程，我为能与各位优秀的伙伴共同构建系统、并肩作战而深感骄傲。无比感恩这一路上塑造了今日之我的每一次宝贵机遇。无论未来如何，我都内心平和、满怀感恩，并真诚地期待与您建立连接与合作。'
  },
  comments: {
    title: '评论区',
    placeholder: '发送评论...',
