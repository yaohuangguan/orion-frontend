export const zh = {
  ...
  resume: {
    ...
    aboutTitle: '关于 Sam',
    aboutEyebrow: '我的主线',
    aboutSubtitle: '我负责把模糊的产品问题，变成清晰、可靠并能上线的系统。',
    aboutCard1Label: '01 · 真实价值',
    aboutCard1Title: '从真实问题开始',
    aboutP1: '先理解用户、业务与限制，再写代码。结果应该让复杂的事情变简单。',
    aboutCard2Label: '02 · 持续成长',
    aboutCard2Title: '把系统做完整',
    aboutP2: '从 React 界面到 Node.js 服务、云基础设施与生产支持，我关注完整交付。',
    aboutCard3Label: '03 · 复合视角',
    aboutCard3Title: '冷静地持续推进',
    aboutP3: '跨团队、跨文化工作让我更重视清晰沟通、工程判断与长期可维护性。'
  },
  comments: {
    title: '评论区',
    placeholder: '发送评论...',
