export const ja = {
  ...
  hero: {
    ...
    introPrefix: '私は ',
    introName: 'Sam',
    introSuffix: 'です。私のデジタルスペースへようこそ。ここでは、個人の考えや履歴書、そして開発プロジェクトを共有しています。フルスタックエンジニアとして、このウェブサイトの構築は純粋に私の趣味であり情熱です。作っていてとても楽しいですし、皆様にもここから楽しさやインスピレーションを感じていただければ幸いです。',
    ctaPrimary: 'ジャーナルを見る',
